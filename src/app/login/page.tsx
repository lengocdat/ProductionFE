    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-lg">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Tìm trận thể thao gần bạn</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="mt-1 w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-green-400" placeholder="••••••" />
          </div>
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          Chưa có tài khoản? <Link href="/register" className="font-medium text-green-600">Đăng ký</Link>
        </p>
      </div>
    </div>
  )
