...
# 👋 Chào mừng đến với AI-DLC cho Thiên Đạo Game! 👋

Tôi sẽ hướng dẫn bạn xây dựng **Thiên Đạo Game** — game Gacha Tu Tiên auto-battler, nơi người chơi đóng vai Tông Chủ tông phái Thiên Cơ, triệu hồi đệ tử qua hệ thống Gacha, chiến đấu tự động với hệ Ngũ Hành, và khôi phục vinh quang tông phái.

## Project Context

**Thiên Đạo Game MVP** bao gồm: Gacha System → Character Management → Auto-Battler Combat → Equipment & Set Bonus → AFK Rewards → PvP Leaderboard → World Boss → Monetization.

**Tech Stack**: 
- Backend: Go (Gin + Uber Fx + GORM) — cấu trúc giống Production
- Frontend: React + Vite + TypeScript + TailwindCSS — cấu trúc giống ProductionFE
- Database: PostgreSQL
- Deploy: Docker Compose (VPS 4GB RAM)

**Key Constraint**: VPS 4GB RAM — PostgreSQL giới hạn 1.5GB, optimize shared_buffers=512MB.

**Game Design Reference**: `deep-research-report.md` chứa toàn bộ thiết kế game chi tiết.
...
- **Output**: Clear requirements, execution plan, decisions on the number of units of work
