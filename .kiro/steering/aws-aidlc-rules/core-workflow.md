...
## Project: Thiên Đạo Game — Gacha Tu Tiên Auto-Battler
**This workflow is configured for the Thiên Đạo Game MVP project.**
- Backend: Go (Gin + Uber Fx + GORM, clean architecture) — cấu trúc giống Production
...
- Core Systems: Gacha, Auto-Battler Combat, Ngũ Hành, AFK Rewards, Monetization
- MVP Rule: If it doesn't help "gacha, chiến đấu, hoặc nạp tiền" — DON'T BUILD IT.
- Reference: deep-research-report.md cho full game design
